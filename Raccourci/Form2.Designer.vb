...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.BlocNoteToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        '
        Me.FichierToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.ApplicationToolStripMenuItem, Me.QuitterAltF4ToolStripMenuItem})
        Me.FichierToolStripMenuItem.Name = "FichierToolStripMenuItem"
        resources.ApplyResources(Me.FichierToolStripMenuItem, "FichierToolStripMenuItem")
        '
        'ApplicationToolStripMenuItem
        '
        Me.ApplicationToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.NotePadToolStripMenuItem, Me.BlocNoteToolStripMenuItem, Me.CalculatriceToolStripMenuItem, Me.GmailToolStripMenuItem, Me.InstagramToolStripMenuItem, Me.TwitterToolStripMenuItem})
        ...
        '
        'BlocNoteToolStripMenuItem
        '
        Me.BlocNoteToolStripMenuItem.Name = "BlocNoteToolStripMenuItem"
        resources.ApplyResources(Me.BlocNoteToolStripMenuItem, "BlocNoteToolStripMenuItem")
        '
        'CalculatriceToolStripMenuItem
        '
        Me.CalculatriceToolStripMenuItem.Name = "CalculatriceToolStripMenuItem"
        resources.ApplyResources(Me.CalculatriceToolStripMenuItem, "CalculatriceToolStripMenuItem")
        '
        'GmailToolStripMenuItem
        '
        Me.GmailToolStripMenuItem.Name = "GmailToolStripMenuItem"
        resources.ApplyResources(Me.GmailToolStripMenuItem, "GmailToolStripMenuItem")
        '
        'InstagramToolStripMenuItem
        '
        Me.InstagramToolStripMenuItem.Name = "InstagramToolStripMenuItem"
        resources.ApplyResources(Me.InstagramToolStripMenuItem, "InstagramToolStripMenuItem")
        '
        'TwitterToolStripMenuItem
        '
        Me.TwitterToolStripMenuItem.Name = "TwitterToolStripMenuItem"
        resources.ApplyResources(Me.TwitterToolStripMenuItem, "TwitterToolStripMenuItem")
        '
        'QuitterAltF4ToolStripMenuItem
        '
        Me.QuitterAltF4ToolStripMenuItem.Name = "QuitterAltF4ToolStripMenuItem"
        resources.ApplyResources(Me.QuitterAltF4ToolStripMenuItem, "QuitterAltF4ToolStripMenuItem")
        '
        'MenuStrip1
        '
    ...
    Friend WithEvents QuitterAltF4ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents PictureBox2 As PictureBox
    Friend WithEvents Label3 As Label
    Friend WithEvents BlocNoteToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Label4 As Label
    Friend WithEvents PictureBox3 As PictureBox
    Friend WithEvents CalculatriceToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents GmailToolStripMenuItem As ToolStripMenuItem
